...
$(function () {
	...
	$.each(config.overlays, function (index, overlay) {
		...
		// Group overlays by translated group name (matching overlay searcher logic)
		if (layerGroup && overlaysTemp[layerGroup] !== undefined) {
	...
	// Now create OpenLayers groups for each group
