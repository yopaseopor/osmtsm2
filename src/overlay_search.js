...
(function() {
    ...
    function getAllOverlays() {
        ...
        if (window.allOverlays) {
            const groupKeys = ['animal', 'business', 'culture', 'economy', 'mobility', 'education', 'food_drink', 'government', 'health', 'leisure', 'logistics', 'office', 'shopping', 'sport', 'transport', 'others'];
